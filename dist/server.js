...
const campaignSteps_routes_1 = __importDefault(require("./routes/campaignSteps.routes"));
...
const financialEntries_routes_1 = __importDefault(require("./routes/financialEntries.routes"));
...
app.use("/api/projects/:projectId/financial-entries", financialEntries_routes_1.default);
...
app.use("/api/campaign", campaignSteps_routes_1.default);
app.use("/api/params", generalParams_routes_1.default);
app.use("/api/credits/:creditId", credits_routes_1.default);
app.use("/api/disbursements/:id", disbursement_routes_1.default);
app.use("/api/statistics/campaigns", statistics_routes_1.default);
